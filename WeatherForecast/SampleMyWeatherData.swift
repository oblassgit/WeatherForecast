...
class SampleMyWeatherData {
    ...
    func getSampleData() -> [MyWeatherData]? {
        return [
            MyWeatherData(isDay: true, windDirection: "SE", latitude: 0.0, longitude: 0.0, apparentTemperature: 23.4, surfacePressure: 1021, dailyWeatherCode: 0),
            MyWeatherData(windDirection: "SSE", latitude: 123, longitude: -23, apparentTemperature: 32, surfacePressure: 989, dailyWeatherCode: 2),
            MyWeatherData(isDay: true, windDirection: "NE", latitude: 123, longitude: -23, apparentTemperature: 34, surfacePressure: 999, dailyWeatherCode: 3),
            ...
            MyWeatherData(isDay: true, windDirection: "NE", latitude: 123, longitude: -23, apparentTemperature: 34, surfacePressure: 999, dailyWeatherCode: 96),
        ]
    }
}
